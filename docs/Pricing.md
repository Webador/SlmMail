...
This table provides an up-to-date (as of May 2013) pricing table for the email providers used in SlmMail. If some
prices appear to be outdated, please create an issue!
